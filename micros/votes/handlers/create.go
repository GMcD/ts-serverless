...
import (
	...
	domain "github.com/GMcD/ts-serverless/micros/votes/dto"
	models "github.com/GMcD/ts-serverless/micros/votes/models"
...
func CreateVoteHandle(c *fiber.Ctx) error {
	...
	go func(currentUser types.UserContext) {
		...
		notificationModel := &models.NotificationModel{
			...
			Description:          fmt.Sprintf("%s likes your post.", currentUser.DisplayName),
			URL:                  URL,
